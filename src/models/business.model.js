...
Business.associate = (models) => {
  Business.hasMany(models.WhatsAppInstance, { foreignKey: 'businessId', as: 'instances' });
  Business.hasMany(models.PostSchedule, { foreignKey: 'businessId', as: 'posts' });
  Business.hasMany(models.SocialAccount, { foreignKey: 'businessId', as: 'socialAccounts' });
};
